...
char g_cSlaveSyncStatus = STATUS_NEWCFG;
...
int master_sync_init(void)
{
    ...
    //½«g_iSyncEventFdÌí¼Óµ½epollÖÐ£¬ÓÉÓÚmainÏß³Ì»áÏòsync·¢ËÍÊÂ¼þ£¬ËùÒÔÐèÒªÓÉmain´´½¨
...
int _epoll_syncEvent(void)
{
    ...
    //»ñÈ¡ÊÂ¼þ±êÖ¾£¬¹²ÓÐ64ÖÖÊÂ¼þ£¬¿ÉÍ¬Ê±´¥·¢¶à¸ö
